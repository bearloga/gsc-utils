...
parser.add_argument("split", choices=['none', 'country', 'device', 'appearance'], default='none',
...
# dev/debug: ['-v', 'cache/creds-mpopov.json', 'en.wikipedia.org', 'none', 'output/enwiki', '2018-03-01', '90']
...
output_filename = args.outdir + '/' + args.split + '.csv'
